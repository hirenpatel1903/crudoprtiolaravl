        ...
        <div class="row h-100 align-items-center">
          ...
          <div class="col-6 col-md-3 col-lg-4">
            <div class="top-header-social-info text-right">
              ...
              <a href="{{url('/user/login')}}" data-toggle="tooltip" data-placement="bottom" title="Pinterest" style="color:blue;font-weight:bold;margin-left:50px">Login</a>
              <a href="{{url('/register')}}" data-toggle="tooltip" data-placement="bottom" title="Pinterest" style="color:blue;font-weight:bold">Register</a>
      ...
      <div class="classy-nav-container breakpoint-off">
        <div class="container">
          ...
          <nav class="classy-navbar justify-content-between" id="dentoNav">
            ...
            <!-- Logo -->
            <a class="nav-brand" href="{{url('user/index')}}"><img src="{{url('user/img/core-img/logo.png')}}" alt=""></a>
            ...
            <div class="classy-menu">
              ...
              <div class="classynav">
                <ul id="nav">
                  ...
                  <li><a href="{{url('user/pricing')}}">Pricing</a></li>
                  <li><a href="#">Blog</a>
                    <ul class="dropdown">
                      <li><a href="{{url('user/blog')}}">- Blog</a></li>
                      <li><a href="{{url('user/blog-details')}}">- Blog Details</a></li>
                    </ul>
                  </li>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-12 col-md-6">
          <div class="about-us-thumbnail mb-50">
            <img src="{{url('user/img/bg-img/15.jpg')}}" alt="">
          </div>
        </div>
        <!-- About Content -->
        <div class="col-12 col-md-6">
      ...
      <div class="row align-items-center">
            ...
            <div class="row">
              ...
              <div class="col-6 col-md-4">
                <div class="single-service mb-70">
                  <img src="{{url('user/img/core-img/s1.png')}}" alt="">
              ...
              <div class="col-6 col-md-4">
                <div class="single-service mb-70">
                  <img src="{{url('user/img/core-img/s2.png')}}" alt="">
                  <h6>Missing Teeth</h6>
                </div>
              </div>
              ...
              <div class="col-6 col-md-4">
                <div class="single-service mb-70">
                  <img src="{{url('user/img/core-img/s3.png')}}" alt="">
                  <h6>Teeth Whitening</h6>
                </div>
              </div>
              ...
              <div class="col-6 col-md-4">
                <div class="single-service mb-70">
                  <img src="{{url('user/img/core-img/s4.png')}}" alt="">
              ...
              <div class="col-6 col-md-4">
                <div class="single-service mb-70">
                  <img src="{{url('user/img/core-img/s5.png')}}" alt="">
                  <h6>Examination</h6>
                </div>
              </div>
        ...
        <div class="col-12 col-lg-6">
          <div class="dento-video-area mb-100">
            <img src="{{url('user/img/bg-img/14.jpg')}}" alt="">
            <!-- Play Button -->
      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="single-dentist-area mb-100">
            <img src="{{url('user/img/bg-img/9.png')}}" alt="">
            <!-- Dentist Content -->
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="single-dentist-area mb-100">
            <img src="{{url('user/img/bg-img/10.png')}}" alt="">
            <!-- Dentist Content -->
            <div class="dentist-content">
              <!-- Social Info -->
              <div class="dentist-social-info">
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="single-dentist-area mb-100">
            <img src="{{url('user/img/bg-img/11.png')}}" alt="">
            <!-- Dentist Content -->
            <div class="dentist-content">
              <!-- Social Info -->
              <div class="dentist-social-info">
          ...
          <div class="testimonials-slides owl-carousel">
            ...
            <div class="single-testimonial-slide d-flex align-items-center">
              ...
              <div class="testimonial-thumb">
                <img src="{{url('user/img/bg-img/8.jpg')}}" alt="">
              </div>
              <!-- Content -->
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="single-blog-item mb-100">
            <a href="{{url('user/blog-details')}}">
              <img src="{{url('user/img/bg-img/4.jpg')}}" alt="">
            </a>
            <!-- Blog Content -->
            <div class="blog-content">
              <a href="{{url('user/blog-details')}}" class="post-title">How your mouth bacteria can harm your lungs</a>
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="single-blog-item mb-100">
            <a href="{{url('user/blog-details')}}">
              <img src="{{url('user/img/bg-img/5.jpg')}}" alt="">
            </a>
            <!-- Blog Content -->
            <div class="blog-content">
              <a href="{{url('user/blog-details')}}" class="post-title">What is the best kind of toothpaste to use?</a>
              <p>Donec tempor, lorem et euismod eleifend, est lectus laoreet ante, sed accusan justo diam ...</p>
              <div class="post-meta">
                <a href="#"><i class="icon_clock_alt"></i> 28 Sep 2018</a>
                <a href="#"><i class="icon_chat_alt"></i> 3 Comments</a>
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="single-blog-item mb-100">
            <a href="{{url('user/blog-details')}}">
              <img src="{{url('user/img/bg-img/6.jpg')}}" alt="">
            </a>
            <!-- Blog Content -->
            <div class="blog-content">
              <a href="{{url('user/blog-details')}}" class="post-title">Why you should avoid sipping your drinks</a>
              <p>Donec tempor, lorem et euismod eleifend, est lectus laoreet ante, sed accusan justo diam ...</p>
              <div class="post-meta">
                <a href="#"><i class="icon_clock_alt"></i> 28 Sep 2018</a>
                <a href="#"><i class="icon_chat_alt"></i> 3 Comments</a>
      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-lg-4">
          <div class="single-footer-widget">
            <a href="{{url('user/index')}}" class="d-block mb-4"><img src="{{url('user/img/core-img/logo.png')}}" alt=""></a>
            ...
            <div class="footer-contact">
              ...
              <p><i class="icon_phone"></i> +91    9726977958</p>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
  ...
  <!-- All js -->
  <script src="{{url('user/js/dento.bundle.js')}}"></script>
  <!-- Active js -->
  <script src="{{url('user/js/default-assets/active.js')}}"></script>
